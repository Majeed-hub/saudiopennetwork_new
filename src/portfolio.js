...
const skills = {
  data: [
    {
      title: "What is Saudi Open Network for Mobility?",
      fileName: "DataScienceImg",
      skills: [
        "The Saudi Open Network for Mobility is an innovative initiative designed to transform the transportation landscape in Saudi Arabia.",
        "It serves as an interoperable platform that connects various transportation services, enabling seamless access and efficient travel solutions across the Kingdom.",
      ],
      softwareSkills: [
        {
    ...
    },
    {
      ...
      skills: [
        "Various mobility providers join the open network.",
        "Users can access a variety of transport services through a single platform",
        "Transactions are conducted directly between consumers and providers, eliminating intermediaries",
        "The open network ensures a fair marketplace, where services are scalable and adaptable",
      ],
      softwareSkills: [
        {
          skillName: "GCP",
